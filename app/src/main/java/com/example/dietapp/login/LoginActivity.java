...
import com.example.dietapp.login.RegisterActivity;

public class LoginActivity extends AppCompatActivity {

    private FirebaseAuth mFirebaseAuth; // firebase 인증처리
    private DatabaseReference mDatabaseRef; // 실시간 데이터베이스
    private EditText mEtEmail, mEtPmd; // 로그인 입력필드
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                mFirebaseAuth.signInWithEmailAndPassword(strEmail, strPwd).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            finish(); // 현재 액티비티 파괴하고 넘어가자.
                            // 말 그대로 앱 종료시키는 거임. 우선은 test 해보는 걸로 얘를 통일하자.
                        }
                        else{
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 회원가입 화면으로 이동
                Intent intent = new Intent(LoginActivity.this, com.example.dietapp.login.RegisterActivity.class);
                startActivity(intent);
            }
        });
    }
